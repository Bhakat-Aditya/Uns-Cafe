        ...
        <div>
          ...
          <div className="space-y-8">
            <div className="flex items-center gap-6 group cursor-pointer">
              ...
              <div>
                <p className="text-gray-500 uppercase text-xs font-bold tracking-widest">Call us</p>
            ...
            <div className="flex items-center gap-6 group cursor-pointer">
              ...
              <div>
                <p className="text-gray-500 uppercase text-xs font-bold tracking-widest">Email us</p>
            ...
            <div className="flex items-center gap-6 group cursor-pointer">
              ...
              <div>
                <p className="text-gray-500 uppercase text-xs font-bold tracking-widest">Visit us</p>
                <p className="text-xl font-medium">37/1, Purna Das Rd, Kalighat, Kolkata</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="relative">
          ...
          <div className="relative z-10 rounded-[3rem] overflow-hidden border border-white/10 shadow-2xl">
            <iframe 
              ...
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3675.123456789!2d88.345678!3d22.534567!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjLCsDMyJzMDLjUiSg4OCKwMjSnMzQuNCJF!5e0!3m2!1sen!2sin!4v1600000000000" 
              width="100%" 
              height="500" 
              style={{ border: 0 }} 
              allowFullScreen="" 
